                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('user.update', Auth::user()->account_id)}}" autocomplete="off">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="email" class="form-control @error('old_email') is-invalid @enderror" name="old_email" required maxlength="39" placeholder="Old Email">
                                @error('old_email')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="email" class="form-control @error('new_email') is-invalid @enderror" name="new_email" required maxlength="39" placeholder="New Email">
                                @error('new_email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{$message}}</strong>
                                    </span>
